class Localization {
  static const Map<String, Map<String, String>> _strings = {
    'ko': {
      ...
      'installed_loader_title': '모더 로더 (MelonLoader) 관리',
      ...
      'installed_btn_replace_loader': '멜론로더로 교체 설치',
      ...
      'explore_filter_sort_name': '이름 순 (A-Z)',
      ...
      'explore_modal_downloads': '총 다운로드',
    ...
    'en': {
      ...
      'explore_modal_downloads': 'Total Downloads',
