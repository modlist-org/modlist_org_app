class Localization {
  static const Map<String, Map<String, String>> _strings = {
    'ko-KR': {
      ...
      'settings_cloud_desc': 'UserData 폴더 및 UMM 모드 설정을 클라우드에 백업합니다. (실행파일/에셋/1MB 이상 제외)',
    ...
    'en-US': {
      ...
      'settings_cloud_desc': 'Backup your UserData and UMM configurations to the cloud. (Excludes binaries, assets, and files > 1MB)',
    ...
    'zh-CN': {
      ...
      'settings_cloud_desc': '将 UserData 和 UMM 配置备份到云端。(不包括二进制文件、资源以及大于 1MB 的文件)',
